...
# 解决方案探讨
针对这个问题，我们尝试了几种解决思路：
1. 避免这样的多个QueryObservable通过flatMap连接的情况，直接通过sql语句来做联合查询。
...
2. 如何在一个订阅链中，使用一个QueryObservableManager ？
